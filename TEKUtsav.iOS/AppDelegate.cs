...
             // get permission for notification
        ...
        }         public override void WillEnterForeground(UIApplication application)         {             ConnectToFCM();         }
        ...
        //{
        //    Console.WriteLine(remoteMessage.AppData);
        //}         public static void ConnectToFCM()         {             Messaging.SharedInstance.Connect(error =>             {                 if (error != null)                 {                     System.Diagnostics.Debug.WriteLine("Unable to connect to FCM " + error.LocalizedDescription);                 }                 else                 {                     System.Diagnostics.Debug.WriteLine("Success! Connected to FCM");                     System.Diagnostics.Debug.WriteLine($"Token: {InstanceId.SharedInstance.Token} ");                      //TODO: Change Topic to what is required                     Messaging.SharedInstance.Subscribe("/topics/news");                 }             });         }         public class UserInfoEventArgs : EventArgs
        {
